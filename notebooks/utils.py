...
def validation_flags_comparison(df_1, df_2, df_1_name: str = "old", df_2_name: str = "new"):
    ...
    flags_as_columns["productive"] = df_1_notna.loc[common_index]["productive"]
    flags_as_columns["complete_vdj"] = df_1_notna.loc[common_index]["complete_vdj"]
    ...
    flags_as_columns["productive"] = df_2_notna.loc[common_index]["productive"]
    flags_as_columns["complete_vdj"] = df_2_notna.loc[common_index]["complete_vdj"]
